...
function getBrandedCategoryImage(categoryName: string, fallback?: string | null): string {
  ...
  if (name.includes("تطبيق") || name.includes("app")) return "/shad-cat-apps.svg";
  if (name.includes("لعب") || name.includes("game")) return "/shad-cat-games.svg";
  if (name.includes("رصيد") || name.includes("balance")) return "/shad-cat-balance.svg";
  if (name.includes("ميديا") || name.includes("سوشل") || name.includes("social")) return "/shad-cat-media.svg";
  if (name.includes("شات") || name.includes("chat")) return "/shad-cat-chat.svg";
  if (name.includes("رقم") || name.includes("number")) return "/shad-cat-numbers.svg";
  if (name.includes("بطاق") || name.includes("card")) return "/shad-cat-cards.svg";

  return fallback || "/shad-cat-apps.svg";
}
    ...
    <div className="relative pb-8 animate-in fade-in duration-500 overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="p-4 pt-6 bg-gradient-to-b from-card/50 to-transparent">
          ...
          <Card className="shad-brand-card shadow-xl overflow-hidden relative">
